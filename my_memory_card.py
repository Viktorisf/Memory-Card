...
from PyQt5.QtWidgets import (QApplication, QWidget, QPushButton, QVBoxLayout, QLabel, QGroupBox, QRadioButton, QHBoxLayout)

app = QApplication([])

window = QWidget()
window.setWindowTitle('Nemo Card')
...
layuot_ans2.addWidget(rbtn_1)
layuot_ans2.addWidget(rbtn_2)
layuot_ans3.addWidget(rbtn_3)
layuot_ans3.addWidget(rbtn_4)
...
layuot_line1.addWidget(lb_Question, alignment=(Qt.AlignHCenter | Qt.AlignVCenter))
...
layuot_card.addLayout(layuot_line1, stretch=2)
layuot_card.addLayout(layuot_line2, stretch=8)
layuot_card.addStretch(1)
layuot_card.addLayout(layuot_line3, stretch=1)
layuot_card.addStretch(1)
layuot_card.setSpacing(5)
...
questions_list.append(Question('Ягоды это вишня', 'ягода', 'арбуз', 'банан', 'яблоко'))
questions_list.append(Question('жук', 'порашут', 'трова', 'яблоня', 'красный'))
questions_list.append(Question('дыня', 'арбуз', 'женя', 'хорошо', 'ниита'))
questions_list.append(Question('привет', 'Упривет как дела', 'яблоко', 'индус', 'дом'))
questions_list.append(Question('даа', 'неет', 'восемь', 'десять', 'золото'))
questions_list.append(Question('никита лох', 'да', 'да', 'да', 'да'))
questions_list.append(Question('зеленый?', 'красный синий', 'феолетовый', 'желтый', 'зеленый'))
